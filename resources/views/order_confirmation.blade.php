            ...
            <div class="order-complete">
                ...
                <div class="order-info">
                    <div class="order-info__item">
                        ...
                        <script>
                            document.getElementById('random-number').textContent = Math.floor(Math.random() * (99999 - 10000 + 1)) + 10000;
                        </script>
                    ...
                    <div class="order-info__item">
                        ...
                        <script>
                            document.getElementById('dynamic-date').textContent = new Date().toLocaleDateString('pt-BR');
                        </script>
                    ...
                    R$ 29,90
                        ...
                        <table class="checkout-totals">
                            <tbody>
                                ...
                                <tr>
                                    <th>TOTAL</th>
                                    <td align="right" style="font-weight: bold; color: #E53935;">
                                        R${{ Cart::instance('cart')->total() }}</td>
                                </tr>
                            </tbody>

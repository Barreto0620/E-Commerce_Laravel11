            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto->imagens->skip(1)->first()->IMAGEM_URL }}"
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto1->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto1->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto1->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto1->imagens->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto1->PRODUTO_ID])}}">{{$produto1->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto2->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto2->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto2->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto2->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto2->PRODUTO_ID])}}">{{$produto2->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto3->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto3->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto3->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto3->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto3->PRODUTO_ID])}}">{{$produto3->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto4->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto4->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto4->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto4->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto4->PRODUTO_ID])}}">{{$produto4->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto5->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto5->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto5->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto5->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto5->PRODUTO_ID])}}">{{$produto5->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto6->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto6->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto6->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto6->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto6->PRODUTO_ID])}}">{{$produto6->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto7->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto7->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto7->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto7->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto7->PRODUTO_ID])}}">{{$produto7->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto8->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto8->imagens->first()->IMAGEM_URL }}" width="330"
                          height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      <a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto8->PRODUTO_ID])}}"><img loading="lazy" src="{{ $produto8->imagens->skip(1)->first()->IMAGEM_URL }}"
                          width="330" height="400" alt=" COLOCAR DESCRIÇÃO " class="pc__img"></a>
                    </div>
                  </div>
                  <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route ('catalogo.details', ['PRODUTO_ID'=>$produto8->PRODUTO_ID])}}">{{$produto8->PRODUTO_NOME}}</a></h6>
                <div class="product-card__price d-flex">

      ...
      <div class="col-lg-5">
        ...
        <form name="addtocart-form" method="post">
          <div class="product-single__addtocart">
            ...
            <button type="submit" class="btn btn-primary btn-addtocart js-open-aside" data-aside="cartDrawer">Comprar</button>
          </div>
        </form>
          ...
          <div class="product-single__reviews-list">
            <div class="product-single__reviews-item">
              <div class="customer-avatar">
                <img loading="lazy" src="{{asset('assets/images/avatar.png')}}" alt="Gabriel Barreto" />
              </div>
              <div class="customer-review">
                ...
                <div class="review-text">
                  <p>"Excelente loja para comprar hardware! Produtos de qualidade, preços justos e ótimo atendimento. Entrega rápida e suporte confiável. Recomendo!"</p>
                </div>
              </div>
            </div>
            <div class="product-single__reviews-item">
              <div class="customer-avatar">
                <img loading="lazy" src="{{asset('assets/images/avatar_1.png')}}" alt="Lucas Ryan" />
              </div>
              <div class="customer-review">
                <div class="customer-name">
                  <h6>Lucas Ryan</h6>
                ...
                <div class="review-date">Avaliado em 2024</div>
                <div class="review-text">
                  <p>"Loja incrível para quem busca hardware de qualidade! Variedade de produtos, preços acessíveis e atendimento excepcional. Totalmente confiável!"</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="swiper-container js-swiper-slider" data-settings='{
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide product-card">
            <div class="pc__img-wrapper">
              <a href="details.html">
                <img loading="lazy" src="{{ $produto10->imagens->first()->IMAGEM_URL }}" width="330" height="400"
                  alt="{{$produto10->PRODUTO_NOME}}" class="pc__img">
                <img loading="lazy" src="{{ $produto10->imagens->skip(1)->first()->IMAGEM_URL }}" width="330" height="400"
                  alt="{{$produto10->PRODUTO_NOME}}" class="pc__img pc__img-second">
              </a>
              <button
                class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
                data-aside="cartDrawer" title="Add To Cart">Carrinho</button>
            ...
            <div class="pc__info position-relative">
              <p class="pc__category">{{$produto10->categoria->CATEGORIA_NOME}}</p>
              <h6 class="pc__title"><a href="#">{{$produto10->PRODUTO_NOME}}</a></h6>
              <div class="product-card__price d-flex">
                <span class="money price">R$: {{$produto10->PRODUTO_PRECO}}</span>
              </div>

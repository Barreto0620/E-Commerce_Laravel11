                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ $produto->imagens->first()->IMAGEM_URL }}" width="104" height="104"
                                            alt="" /></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ $produto->imagens->first()->IMAGEM_URL }}" width="104" height="104"
                                            alt="" /></div>
                                ...
                                <div class="swiper-slide product-card" style="margin-right: 15px;"> <!-- Espaçamento -->
                                    ...
                                    <div class="pc__info position-relative">
                                        ...
                                        <h6 class="pc__title"><a
                                                href="{{ route('catalogo.details', ['PRODUTO_ID' => $produtoRelacionado->PRODUTO_ID]) }}">{{ $produtoRelacionado->PRODUTO_NOME }}</a>
                                        </h6>
...
@endsection
>>>>>>> 30e633151a7f7c9b7d1763681a1c637848574042

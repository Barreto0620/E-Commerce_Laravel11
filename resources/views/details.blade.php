                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        @if ($produto->imagens->isNotEmpty())
                                            <img loading="lazy" class="h-auto"
                                                src="{{ $produto->imagens->first()->IMAGEM_URL }}" width="374"
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        @if ($produto->imagens->isNotEmpty())
                                            <img loading="lazy" class="h-auto"
                                                src="{{ $produto->imagens->first()->IMAGEM_URL }}" width="674"
                                                height="674" alt="Imagem do produto" />
                                        @else
                                            <img loading="lazy" class="h-auto"
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach ($produto->imagens as $imagem)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ $imagem->IMAGEM_URL }}"
                                                width="104" height="104" alt="Thumbnail do produto" />
                                        </div>
                                    @endforeach
                            ...
                            @foreach ($produtosRelacionados as $produtoRelacionado)
                                <div class="swiper-slide product-card" style="margin-right: 15px;">
                                    <div class="pc__img-wrapper">
                                        <a
                                            href="{{ route('catalogo.details', ['PRODUTO_ID' => $produtoRelacionado->PRODUTO_ID]) }}">
                                        ...
                                        @if (Cart::instance('cart')->content()->where('id', $produtoRelacionado->PRODUTO_ID)->count() > 0)
                                        ...
                                        @else
                                            <form name="addtocart-form" method="POST" action="{{ route('cart.add') }}">
                                                ...
                                                <input type="hidden" name="PRODUTO_ID"
                                                    value="{{ $produtoRelacionado->PRODUTO_ID }}">
                                                <input type="hidden" name="PRODUTO_NOME"
                                                    value="{{ $produtoRelacionado->PRODUTO_NOME }}">
                                                <input type="hidden" name="PRODUTO_PRECO"
                                                    value="{{ $produtoRelacionado->PRODUTO_PRECO }}">
                                                <button type="submit"
                                                    class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium"
                                                    data-aside="cartDrawer" title="Add To Cart">Comprar</button>
                                            </form>
                                        @endif
                                    </div>
                                    ...
                                    <div class="pc__info position-relative">
                                        <p class="pc__category">
                                            {{ $produtoRelacionado->categoria->CATEGORIA_NOME ?? 'Sem categoria' }}</p>
                                        <h6 class="pc__title">
                                            <a
                                                href="{{ route('catalogo.details', ['PRODUTO_ID' => $produtoRelacionado->PRODUTO_ID]) }}">
